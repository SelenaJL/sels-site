...
const mainCardContent = {
  title: 'Animal Rescue',
  text: 'One of my biggest passions is helping animals. I\'ve volunteered for Pet Patrol Cat Rescue serving the Kitchener-Waterloo region, AVA Cat Rescue serving the Greater Toronto Area, and TEAM Cat Rescue \
  taking in cats from kill shelters all over the world. Thanks to these incredible non-profit organizations, I\'ve had the pleasure of fostering 23 cat and counting! This includes socializing, \
  providing medical care, and faciliating adoptions. You can read about each of my fosters below and find more photos on my Instagram account. If you have questions about cats or opportunities to \
  contribute to the animal rescue community, I\'d be delighted to chat.',
  buttons: [
    { logo: '/instagram-logo.png', text: '@selsfosterdiaries', link: 'https://www.instagram.com/selsfosterdiaries/' },
    { logo: '/team-cat-logo.png', text: 'More about TEAM Cat', link: 'https://teamcatrescue.com/' },
    { logo: '/pet-patrol-logo.png', text: 'More about Pet Patrol', link: 'https://www.petpatrol.ca/' },
    { logo: '/ava-logo.png', text: 'More about AVA', link: 'https://www.avacats.org/' },
  ],
};
